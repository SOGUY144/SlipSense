  ...
  return (
    ...
    <PullToRefresh onRefresh={load}>
      ...
      <div className="relative pt-4 pb-6">
        {/* Colorful Blurred Orbs in Background */}
        <div className="absolute top-[10%] left-[10%] w-[120px] h-[120px] bg-[#43936C]/40 rounded-full blur-[40px] pointer-events-none -z-10 animate-pulse" />
        <div className="absolute top-[-10px] right-[10%] w-[140px] h-[140px] bg-[#3b82f6]/30 rounded-full blur-[45px] pointer-events-none -z-10 animate-pulse delay-1000" />
        <div className="absolute bottom-[20%] left-[40%] w-[100px] h-[100px] bg-[#8b5cf6]/20 rounded-full blur-[40px] pointer-events-none -z-10 animate-pulse delay-700" />

        <div className="mx-4 bg-white/70 backdrop-blur-2xl border border-white rounded-[2rem] px-6 pt-8 pb-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col items-center justify-center relative overflow-hidden">
