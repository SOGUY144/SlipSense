  ...
  try {
    ...
    const values = DEMO_TRANSACTIONS.map((tx) => {
      ...
      return {
        ...
        amount: tx.amount,
        occurredAt,
        sender: tx.type === "income" ? tx.sender : null,
        receiver: tx.type === "expense" ? tx.receiver : null,
        note: tx.note,
